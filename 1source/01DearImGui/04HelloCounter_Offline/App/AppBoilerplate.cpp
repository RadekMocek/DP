...
bool App::Init()
{
    ...
    m_window = glfwCreateWindow(static_cast<int>(1280 * main_scale), static_cast<int>(800 * main_scale), m_window_title, nullptr, nullptr);
    if (m_window == nullptr)
        return false;
...
void App::Run()
{
...
#endif
    {
        ...
        glClearColor(m_clear_color.x * m_clear_color.w, m_clear_color.y * m_clear_color.w, m_clear_color.z * m_clear_color.w,
                     m_clear_color.w);
