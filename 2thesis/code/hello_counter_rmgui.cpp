...
void App::init() {
    ...
    connect(button_counter_decrement, &QPushButton::clicked,
            this, &App::on_button_decrement_clicked);
    ...
    connect(button_counter_increment, &QPushButton::clicked,
            this, &App::on_button_increment_clicked);
