...
\begin{document}
	...
	Protože ukázkovou aplikací této práce je editor diagramů inspirovaný přístupem WYSIWYM, zaměřuje se rešerše knihoven více na ty aspekty, které budou při tvorbě této aplikace určitě potřeba. Je pravděpodobné, že všechny knihovny budou disponovat ovládacími prvky jako tlačítko nebo textové pole, otázkou ale je, jaké mají tyto prvky funkce. U textového pole se např. hodí zvýrazňování syntaxe, hledání v textu, našeptávání, klávesové zkratky pro kopírování a vkládání apod. Druhou důležitou částí vedle textového editoru je kreslící plátno, které obsahuje vykreslený diagram odpovídající danému textu. Pro jeho realizaci by knihovna měla poskytovat funkce pro kreslení grafických primitiv.
