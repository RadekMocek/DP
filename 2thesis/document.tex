...
\begin{document}
	...
	% * i přesto jde ale ruku v ruce s realtime aplikacemi (immediate mode nemusí nutně znamenat že imgui jede na opengl aspol.)
	% * výhody - gui neuchovává žádná data, pokud chci využít data z textboxu v jiném widgetu, nemusím přistupovat k textbox inner state, ...
	% * nevýhody:
	% * - https://gamedev.stackexchange.com/a/24148/167872
	
	% důsledky opengl aspol: vypadá to všude stejně :), fonty :(
