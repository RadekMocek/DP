...
\begin{document}
	...
	\begin{itemize}
		\item Návrh obecně: nodes + paths, relative position
		\item JSON/XML/YAML/TOML/custom
		\item kromě TOML→diagram také návrh zbylého GUI
	\end{itemize}
	...
	% * backend zvolen glfw3, problémy s verzemi
